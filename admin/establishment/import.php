        ...
        if(is_uploaded_file($_FILES['file']['tmp_name'])){
            ...
            while(($line = fgetcsv($csvFile)) !== FALSE){
                ...
                if($prevResult->num_rows > 0){
                    ...
                    $db->query("INSERT INTO establishment (id, code, name, address, city_id, zone_id, address, zone_id, image_path) VALUES ('".$id."','".$code."','".$name."','".$address."','".$city_id."','".$zone_id."','".$image_path."')");
                }
            }
